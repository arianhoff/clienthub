...
export function RequestDetailContent({ request, comments, orgSlug }: RequestDetailContentProps) {
  ...
  const basePath = `/org/${orgSlug}/dashboard`
          ...
          <div className="space-y-6">
            ...
            {client && (
              <div className="bg-white rounded-2xl border border-gray-200 p-6">
                ...
                <Link href={`${basePath}/clients/${client.id}`} className="flex items-center gap-3 mb-4 hover:bg-gray-50 -mx-2 px-2 py-2 rounded-lg transition">
                  <div
